...
// SamesLib.neophyte.rs - NOTE:  NON-COMPILING VERSION!!!
// This copy represents an attempt to use enum based arrays for my composite
// class instead of trait objects.  I still wonder if there is a way to make
// this work, as I was very close, but it appears to be irregular, so for now
// it's set aside (xc 202312191355).
